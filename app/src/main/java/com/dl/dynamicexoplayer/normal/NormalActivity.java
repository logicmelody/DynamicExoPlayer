package com.dl.dynamicexoplayer.normal;
...
public class NormalActivity extends AppCompatActivity {
	...
	private void addMediaToPlayerController() {
		for (String url : mUrls) {
			PlayerController.getInstance(this).addMedia(this, url);
		}
	}

	private void bindWithPlayer() {
		PlayerController.getInstance(this).addEventListener(mPlayerEventListener);
