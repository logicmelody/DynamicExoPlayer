...
public class SlideActivity extends AppCompatActivity {
	...
	@BindView(R.id.view_pager_slide_media)
			...
			public void run() {
				Observable.create(new ObservableOnSubscribe<String>() {
					...
					public void subscribe(ObservableEmitter<String> emitter) throws Exception {
						emitter.onNext(ApiManager.getInstance(SlideActivity.this).run("https://raw.github.com/square/okhttp/master/README.md"));
					}
						...
						.subscribe(new Observer<String>() {
							...
							public void onNext(String s) {
								Toast.makeText(SlideActivity.this, "Http request successful", Toast.LENGTH_SHORT).show();
							}
